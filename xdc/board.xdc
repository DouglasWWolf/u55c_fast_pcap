...
set_clock_groups -group [get_clocks HBM0_REFCLK -include_generated_clocks] -asynchronous
...
set_clock_groups -group [get_clocks HBM1_REFCLK -include_generated_clocks] -asynchronous
