...
//=============================================================================
// 24-Jun-26  DWW    1   Initial creation
//=============================================================================
...
module axis_chain_fifo #
(
    parameter TDATA_WIDTH = 512,
    parameter FIFO_DEPTH = 1024,
    parameter FIFO_MEMORY_TYPE = "auto",
    parameter SECTIONS = 1
...
// One per section, plus an extra one to come out of the last axis_slice
...
for (i=0; i<SECTIONS; i=i+1) begin
    ...
    //=============================================================================
    // The output side of each individual FIFO section connects to an axis_slice.
    // The output of each axis-slice connects to the next FIFO in the chain
    //=============================================================================
    axis_slice #
    (
